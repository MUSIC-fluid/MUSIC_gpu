...
void Init::initialize_hydro_fields(Field *hydro_fields, InitData *DATA) {
    ...
    hydro_fields->qi_array = new double* [5];
    hydro_fields->qi_array_new = new double* [5];
    ...
    hydro_fields->expansion_rate = new double[n_cell];
    ...
    for (int i = 0; i < 4; i++) {
        ...
        hydro_fields->Du_mu[i] = new double[n_cell];
        hydro_fields->D_mu_mu_B_over_T[i] = new double[n_cell];
    }
    for (int i = 0; i < 10; i++) {
